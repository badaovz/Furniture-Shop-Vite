...
function Navbar() {
    ...
    const { myUser, isAuthenticated, loginWithRedirect, logout } =
        useUserContext();
                    ...
                    <div className='navbar__right'>
                        <Link className='navbar__right__cart' to='/cart'>
                            ...
                            <span className='navbar__right__cart__icon'>
                                <FaShoppingCart />
                                <span className='navbar__right__cart__icon__total'>
                                    {total_items}
                                </span>
                            </span>
                        </Link>
                        {isAuthenticated ? (
                            ...
                            >
                                ...
                                <span className='navbar__right__login__icon'>
                                    <FaSignOutAlt />
                                </span>
                                {/* (Logout) */}
                            </button>
